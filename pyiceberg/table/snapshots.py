...
class Snapshot(IcebergBaseModel):
    ...
    key_id: str | None = Field(alias="key-id", default=None, description="Encryption key ID for the manifest list")
    ...
    def __repr__(self) -> str:
        ...
        fields = [
            ...
            f"key_id={self.key_id!r}" if self.key_id is not None else None,
        ]
